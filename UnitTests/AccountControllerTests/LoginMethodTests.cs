...
public class LoginMethodTests
{
    ...
    public async Task Login_ModelIsNotValid_ReturnBadRequest()
    {
        ...
        var stubAccountService = new Mock<IAccount>();
        ...
        var controller = new AccountController(stubUserManager.Object, stubSignInManager.Object, stubUserStore.Object,
            stubJwtGenerator.Object, stubAccountService.Object);
    ...
    public async Task Login_IncorrectLoginOrPassword_ReturnUnauthorized()
    {
        ...
        var stubJwtGenerator = new Mock<IJwtGenerator>();
        var stubUserStore = new Mock<IUserStore<User>>();
        var controller = new AccountController(stubUserManager.Object, stubSignInManager.Object,
            stubUserStore.Object, stubJwtGenerator.Object, stubAccountService.Object);

        stubUserManager.Setup(um => um.FindByEmailAsync(It.IsAny<string>()))
            .ReturnsAsync(new User());

        stubSignInManager.Setup(sim => sim.PasswordSignInAsync(It.IsAny<string>(),
